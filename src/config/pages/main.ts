import { Octagon, Rectangle, Square } from "@/components/svg/shapes";
import assets from "../assets";
import { pricingText } from ".";

const packages = pricingText.pricingPackages.packages;
...
const testimonials = [
  {
    stars: 5,
    title: "OMG! I cannot believe that I have got a brand new landing page after getting Bussli. It was super easy to edit and publish.",
    user: "Franklin Hicks",
    job: "Web Developer",
...
export default { main, services, testimonials, story, choose, studies, pricing };