  ...
  return (
    ...
    >
      <div className="flex justify-between gap-5">
        <div className="flex max-w-[33.8rem] flex-col gap-5 lg:gap-7">
          <PageTitle
            nav={config.nav}
            title={config.title}
            titleType="mainTitle"
        ...
        <div className="absolute size-[20rem] max-md:-right-[1.19rem] max-md:bottom-[2.92rem] lg:relative xl:size-[22.65rem]">
          <img
            src={config.img}
            alt="female-img-oval"
