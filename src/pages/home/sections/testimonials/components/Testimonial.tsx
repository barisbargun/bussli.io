...
const Testimonial = ({
  ...
  return (
    <CarouselItem className="flex-center gap-[2.5rem]">
      ...
      <div className="flex flex-col">
        ...
        <h3 className="font-poppins mt-4 line-clamp-3 text-2xl font-bold leading-8 tracking-[-0.0125rem]">
          "{title}"
        </h3>
        <h5 className="font-poppins mt-4 font-bold">{user}</h5>
